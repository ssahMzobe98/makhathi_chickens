...
class MailService implements IMailServiceImplemtation
{
    ...
    private function bodyText(string $message=''):string{
        ...
        $mess .='<div style="width:40px;height:40px;margin-left:5%;border-radius:100%;padding:1px 1px;background:#f2f2f2;"><img style="width:100%;height:100%;border-radius:100%;" src="https://makhathichickens.co.za/img/logo.jpg"></div>';
        $mess .='<div><h3 style="color:#000000;font-size:18px;font-weight:bolder;">Netchatsa</h3></div>';
        $mess .='</div>';
        $mess .= '<h3 style="color:#000000;">Dear Customer <i class="fa-regular fa-thumbs-up"></i></h3>'.$message;
        $mess .="<br><div><a href='https://play.google.com/store/apps/details?id=com.mmshightech.makhathi_chickens'><span class='badge badge-primary text-center text-white' style='padding:10px 10px;background:navy;color:white;'>Download APP</span></a></div>";
        $mess .= '<br><hr><div style="padding:10px 10px;border:1px solid #000000;font-style:italic;font-size:10px;color:red;">makhathi chickens mailer is a communication system developed by makhathi chickens. If this mail does not belong to you please ignore it. Do not reply to this email as it is controlled by RoboTech.<br></div><br>
