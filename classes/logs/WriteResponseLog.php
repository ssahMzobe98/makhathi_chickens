...
class WriteResponseLog{
	...
	public static function writelogResponse(string $dir='./',string $logType='Error',string $class='ErrorLog',string $method='No method provided',?object $data=null){
		self::logResponse2Disk($dir,$logType,$class,$method,$data);

	}
	private static function logResponse2Disk(string $dir='./', string $logType='Error', string $class='errorLog', string $method='No method provided', ?object $data=null) {
		$class.='_'.date("Y-m");
