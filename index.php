...
include_once "vendor/autoload.php";
 ...
 if(!empty($loginObj)){
     ...
     <body>
        ...
        <script>
            loader("login");
            function loader(tVar){
                $(".navigator-load").html("<img src='img/loader.gif' style='width:100%;border-radius: 20px;'>").load("routes/routes.php?"+tVar);
            }
            function siyaVelifayaManje(){
                const verification_Code = $(".verification_Code").val();
                const emailAddress = $(".emailAddress").val();
                $(".verification_Code").removeAttr("style");
            ...
            function sakhaEntsha(){
                ...
                $(".processing").removeAttr("hidden").attr("style","color:white;border:1px solid green;").html("<div><img src='img/loader.gif' style='width:15%;border-radius: 20px;'> Processing...</div>");
                if(name===""){
                    $(".name").attr("style","border-bottom:2px solid red;");
                    $(".processing").removeAttr("hidden").attr("style","color:red;border:1px solid red;").html("Email Field Missing!");
                }
                else if(phone===""){
                    ...
                    $(".pass").attr("style","border-bottom:2px solid red;");
                    $(".processing").removeAttr("hidden").attr("style","color:red;border:1px solid red;").html("Password Field Missing!");
                }
                else{
                    $.ajax({
